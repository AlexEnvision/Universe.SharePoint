...
using Universe.Sp.CSOM.CQRS.Models.Dto;
using Universe.Sp.CSOM.DataAccess;

namespace Universe.Sp.CSOM.CQRS.Infrastructure
{
    public class UniverseSpScope<TUniverseSpCsomContext> : IUniverseSpScope, IDisposable where TUniverseSpCsomContext : class, IUniverseSpCsomContext
    {
            ...
            IUnityContainer container)
        {
            ...
            var universeSpContext = CreateSpContext(webUrl, login, domain, password);
        ...
        public IUniverseSpCsomContext SpCtx { get; set; }
        ...
        private TUniverseSpCsomContext CreateSpContext(string webUrl, string login, string domain, string password)
        {
            ...
            var instance = Activator.CreateInstance(typeof(TUniverseSpCsomContext), webUrl, login, domain, password);
            var typedInstance = instance as TUniverseSpCsomContext;
