...
using Universe.Sp.CSOM.CQRS.Dal.Mappings.FilterMappings.Base;
...
namespace Universe.Sp.CSOM.CQRS.Dal.Mappings.FilterMappings
{
    ...
    /// </summary>
    internal sealed class SearchFilterAndMapping : CamlChainElementBaseMapping<AndConfiguration, CamlChainRule>
    {
