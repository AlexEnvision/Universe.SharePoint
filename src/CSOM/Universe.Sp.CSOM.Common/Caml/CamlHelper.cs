...
namespace Universe.Sp.Common.CSOM.Caml
{
    ...
    public static class CamlHelper
    {
        ...
        public static string BuildCamlPeriodFilter(string fieldName, DateTime? beginDate, DateTime? endDate)
        {
            ...
            if (beginDate != null && beginDate.Value != DateTime.MinValue)
                beginFilter = GetComparisonOperators(
                    ...
                    false,
                    Types.DATE_TIME,
                    //SPUtility.CreateISO8601DateTimeFromSystemDateTime(beginDate.Value.Date),
                    beginDate.Value.Date.ToString(CultureInfo.InvariantCulture),
                    false);
            ...
            if (endDate != null && endDate.Value != DateTime.MinValue)
                endFilter = GetComparisonOperators(
                    ...
                    //SPUtility.CreateISO8601DateTimeFromSystemDateTime(
                        endDate.Value.Date.Add(new TimeSpan(1, 0, 0, 0)).ToString(CultureInfo.InvariantCulture),
                    false);
        ...
        /// </summary>
        /// <param name="idsFields">The ids fields.</param>
        /// <returns>FieldRef tags.</returns>
        /// <exception cref="System.ArgumentNullException">idsFields</exception>
        ...
        /// </summary>
        /// <param name="namesFields">The name fields.</param>
        /// <returns>FieldRef tags.</returns>
        ...
        /// <param name="fieldId">The field identifier.</param>
        /// <param name="isLookupId">if set to <c>true</c> [is lookup identifier].</param>
        /// <param name="type">The type.</param>
        /// <param name="value">The value.</param>
        /// <param name="isIncludeTimeValue">if set to <c>true</c> [is include time value].</param>
        /// <returns></returns>
        ...
        /// CAML выражение.
        /// </returns>
        public static string GetEqLookup(string fieldName, FieldLookupValue value, bool isLookupId)
        {
            if (string.IsNullOrEmpty(fieldName))
                throw new ArgumentNullException(nameof(fieldName));
        ...
        /// <param name="isLookupId">if set to <c>true</c> [is lookup identifier].</param>
        /// <returns></returns>
        public static string GetEqLookup(Guid fieldId, FieldLookupValue value, bool isLookupId)
        {
            string result;
            if (value != null)
            {
        ...
        /// <summary>
        /// Строит CAML выражение: значение поля равно указанному значению (сравнение происходит по идентификатору).
        /// </summary>
        /// <param name="fieldName">
        /// Наименование поля.
        /// </param>
        ...
        public static string GetEqLookup(string fieldName, int id)
        {
            ...
            return GetEqLookup(fieldName, new FieldLookupValue { LookupId = id }, true);
        }
        ...
        {
            return GetEqLookup(fieldId, new FieldLookupValue { LookupId = id }, true);
        }
        ...
        public static string GetInTexts(string fieldName, IEnumerable<string> texts)
        {
            ...
            var textList = texts.Where(x => !string.IsNullOrEmpty(x)).ToList();
            if (textList.Count == 0)
        ...
        /// <summary>
        /// Строит CAML выражение: значение поля не равно указанному значению (сравнение происходит по идентификатору).
        /// </summary>
        /// <param name="fieldName">
        /// Наименование поля.
        /// </param>
        ...
        public static string GetNeqLookup(string fieldName, int id)
        {
            ...
            return GetNeqLookup(fieldName, new FieldLookupValue{ LookupId = id }, true);
        }
        ...
        /// CAML выражение.
        /// </returns>
        public static string GetNeqLookup(string fieldName, FieldLookupValue value, bool isLookupId)
        {
            if (string.IsNullOrEmpty(fieldName))
                throw new ArgumentNullException(nameof(fieldName));
        ...
        /// <summary>
        /// Теги используемые CAML выражениях.
        /// </summary>
